...
public sealed class SessionControlState
{
    ...
    public List<string> AppServerControlOnlySessionIds { get; set; } = [];
    ...
    public Dictionary<string, string> AppServerControlResumeThreadIds { get; set; } = new(StringComparer.Ordinal);
