...
export const THEMES: Record<ThemeName, TerminalTheme> = {
  ...
  light: {
    ...
    scrollbarSliderBackground: 'rgba(37, 30, 24, 0.15)',
    scrollbarSliderHoverBackground: 'rgba(37, 30, 24, 0.3)',
    scrollbarSliderActiveBackground: 'rgba(37, 30, 24, 0.45)',
    black: '#0A0806',
    red: '#CF3333',
    green: '#028200',
    yellow: '#7B6028',
