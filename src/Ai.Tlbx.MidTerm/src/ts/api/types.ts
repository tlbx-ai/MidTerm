...
export type LogFilesResponse = Schemas['LogFilesResponse'];
export type LogEntryMessage = Schemas['LogEntryMessage'];
export type LogReadResponse = Schemas['LogReadResponse'];
...
export type LogSeverity = Schemas['LogSeverity'];
...
export type LogLevelSetting = LogSeverity;
