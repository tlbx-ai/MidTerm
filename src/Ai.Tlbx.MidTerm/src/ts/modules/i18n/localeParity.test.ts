...
const { createLocaleParityReport, STAGED_REQUIRED_PREFIXES } = require('../../../../scripts/locale-parity.cjs') as {
...
describe('locale parity', () => {
  ...
  it('has no missing keys for the staged high-visibility prefixes', () => {
    ...
    expect(enforcedMissing, `Expected parity for prefixes: ${STAGED_REQUIRED_PREFIXES.join(', ')}`).toEqual(
      [],
    );
  });
});
