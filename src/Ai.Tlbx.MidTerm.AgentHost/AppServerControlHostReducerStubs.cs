...
namespace Ai.Tlbx.MidTerm.Services.Sessions
{
    ...
    {
        private readonly ConcurrentDictionary<string, HostAppServerControlSessionInfo> _sessions = new(StringComparer.Ordinal);

        public HostAppServerControlSessionInfo? GetSession(string sessionId)
        {
        ...
        public void SetWorkingDirectory(string sessionId, string? workingDirectory)
        {
            ...
            _sessions[sessionId] = new HostAppServerControlSessionInfo
            {
                SessionId = sessionId,
    ...
    public sealed class HostAppServerControlSessionInfo
    {
