...
public static class Program
{
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        Console.Error.WriteLine($"[mthost] {VersionInfo.Version} starting, session={config.SessionId}");
    ...
    private static async Task RunAsync(SessionConfig config)
    {
        ...
        try
        {
            Console.Error.WriteLine($"[mthost] Creating PTY: {shellConfig.ExecutablePath}");
            ...
            Console.Error.WriteLine($"[mthost] PTY created, PID={pty.Pid}");
            ...
            Console.Error.WriteLine($"[mthost] Listening on: {endpoint}");
