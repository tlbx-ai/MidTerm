...
- implemented: Lens no longer carries the old browser-side `history-index-scroll` repair shim during activation; releases now assume the current end-to-end Lens shell contract instead of patching older in-memory session DOM forward
